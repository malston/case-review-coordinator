...
install-live: check-poetry ## Install dev tools + the optional live deps (anthropic, dotenv)
...
demo: check-poetry ## Run the offline coordinator demo (happy / timeout / ambiguous)
